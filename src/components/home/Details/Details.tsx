...
export default function AboutUs() {
  return (
    <section className="p-10 bg-green-100"> {/* Add your desired background color for the outer area */}
      {/* About Us Section */}
      <div className="container mx-auto mt-8 space-y-8">
        <div className="border-2 border-green-800 rounded-lg p-6 bg-green-50"> {/* Light green background inside the border */}

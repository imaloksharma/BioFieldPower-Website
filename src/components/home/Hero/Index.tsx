  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center lg:text-left lg:ml-16">
        <h1 className="text-2xl lg:text-8xl font-bold text-white italic mix-blend-overlay drop-shadow-lg transition-transform duration-700 ease-in-out hover:translate-y-2">
          Empowering <br/>
          Renewable <br/>
          Energy
        </h1>
        <p className="mt-4 text-sm lg:text-3xl font-bold text-white mix-blend-overlay drop-shadow-lg transition-opacity duration-700 ease-in-out hover:opacity-80">

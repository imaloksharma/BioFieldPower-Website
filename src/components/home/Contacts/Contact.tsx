...
//                   className="w-full bg-white-100 text-gray-800 border border-gray-300 rounded-md p-2 text-sm 
//                             focus:outline-none focus:ring-2 focus:ring-green-600 h-[150px]"
//                 ></textarea>
//               </div>
//             </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-4 shadow-md rounded-md border border-gray-400 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div key={key} className="col-span-2 sm:col-span-1">
                    ...
                    {key === "message" ? (
                      <textarea
                        ...
                        className="w-full bg-gray-100 text-gray-800 border-gray-300 rounded-md p-1 h-20 text-sm focus:outline-none focus:ring-2 focus:ring-green-600"
                      />
                    ) : (
                      <input
              ...
              <div className="col-span-2">
                ...
                <input
                  ...
                  className="w-full bg-gray-100 text-gray-800 border-gray-300 rounded-md p-1 text-sm focus:outline-none focus:ring-2 focus:ring-green-600"
                />
                <iframe width="100%" height="200" title="Google Map" className="rounded-md border border-gray-300 shadow mt-2" src={`https://maps.google.com/maps?q=${encodeURIComponent(formData.location)}&output=embed`}></iframe>
              </div>
                            <div className="col-span-2 flex justify-center md:justify-start">
